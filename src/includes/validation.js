    ...
    configure({
      generateMessage: (ctx) => {
        const messages = {
          ...
          alpha_spaces: `The ${ctx.field} may only contain alphabetical characters and spaces`,
          ...
          country_excluded: `Due to restrictions, we do not accept users from your location`,
